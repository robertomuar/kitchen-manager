...
<div class="container my-5">
  <h1 class="h3 mb-4">Editar Ingrediente</h1>
  ...
  <form action="{{ route('ingredients.update', $ingredient) }}" method="POST">
    ...
    <div class="row">
      ...
      <div class="col-md-3 mb-3">
        ...
        <input type="number" step="0.01" name="quantity" id="quantity"
               ...
               value="{{ old('quantity', $ingredient->quantity) }}" required>
      ...
      <div class="col-md-3 mb-3">
        ...
        <input type="number" step="0.01" name="min_quantity" id="min_quantity"
               ...
               value="{{ old('min_quantity', $ingredient->min_quantity) }}" required>
      ...
      <div class="col-md-3 mb-3">
        ...
        <select name="unit" id="unit"
          ...
          @foreach(\App\Models\Ingredient::units() as $code => $label)
            <option value="{{ $code }}"
                    @selected(old('unit', $ingredient->unit) == $code)>
              {{ $code }} — {{ $label }}
            </option>
          @endforeach
        </select>
      ...
      <div class="col-md-3 mb-3">
        ...
        <select name="location" id="location"
          ...
          @foreach(\App\Models\Ingredient::locations() as $loc)
            <option value="{{ $loc }}"
                    @selected(old('location', $ingredient->location) == $loc)>
              {{ $loc }}
            </option>
          @endforeach
        </select>
    ...
    <button type="submit" class="btn btn-primary">
      <i class="bi bi-save"></i> Actualizar ingrediente
    </button>
